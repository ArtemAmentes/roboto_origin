...
Репозиторий состоит из трёх основных модулей. Документация по ссылкам ниже:

### 📂 Индекс основных модулей
...
```text
├── Roboto_Mechanical/       # [Основной] Конструкция робота, URDF, руководства по сборке
├── Roboto_Power/            # [Схемы] Силовая плата (48 В)
├── Roboto_Usb2Can/          # [Схемы] Модуль связи (USB -> 4xCAN)
```
