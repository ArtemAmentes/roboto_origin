...
- Установите Isaac Lab по [официальной инструкции](https://isaac-sim.github.io/IsaacLab/main/source/setup/installation/index.html). Рекомендуется установка через conda.

- Клонируйте репозиторий отдельно от Isaac Lab:

```bash
git clone https://github.com/Roboparty/atom01_train.git
```

- Установите библиотеки (в окружении с Isaac Lab):
