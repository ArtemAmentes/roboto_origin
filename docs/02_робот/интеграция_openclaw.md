# Интеграция робот с OpenClaw

Связка железной платформы (робот) и платформы AI-агентов (OpenClaw) для zero-code управления роботом.
...
| WP-O2 | Изучение ClawBody, адаптация под atom01/робот | Мост OpenClaw → ROS2 / atom01_deploy |
| WP-O3 | Skill «управление роботом» для OpenClaw | API робот, вызовы из агента |
...
- **робот** — платформа для исполнения (железо, ROS2, deploy)
