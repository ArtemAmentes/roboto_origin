# Русская документация roboto_origin

Черновики и готовые переводы документации roboto_origin на русский язык.

## Созданные файлы

- `README_RU.md` — основной README проекта (в корне репо)
